# Сетевая инфраструктура для проекта [devops](https://github.com/andrew-dibov/devops)
...
> Инфраструктура опирается на [bootstrap проект](https://github.com/andrew-dibov/devops-bootstrap)

## Архитектура

### Слой 1 : Бэкенд и авторизация : Terraform
...
### Слой 2 : VPC и подсети : Yandex Cloud
