...
Создание сетевой инфраструктуры под рабочие нагрузки проекта [DevOps](https://github.com/andrew-dibov/devops). VPC с публичными и приватными подсетями в нескольких зонах доступности для [High Availability Kubernetes](https://github.com/andrew-dibov/devops-kubernetes), NAT-шлюз, таблица маршрутизации, группа безопасности и бастион с SSH-ключом в хранилище секретов.
