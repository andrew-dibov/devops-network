...
Развертывание сети под рабочие нагрузки : VPC с публичными и приватными подсетями в нескольких зонах доступности, NAT-шлюз с таблицей маршрутизации, группа безопасности и бастион-хост с SSH-ключом в хранилище секретов.
...
Основная сеть со следующими подсетями :
...
- **NAT-шлюз** : выход в интернет для приватных подсетей
- **Таблица маршрутизации** : маршрут `0.0.0.0/0` через NAT-шлюз

### Слой 3 : Бастион

VM с публичным IP и группой безопасности :
